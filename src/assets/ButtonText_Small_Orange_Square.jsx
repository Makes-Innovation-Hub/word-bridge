    ...
    >
      ...
      <g id="Top">
        <g>
          ...
          <path
            className="cls-1"
            d="m20.3,183.1c-.8-16.9,0-33.8.5-50.7.8-29.3-1.4-58.6-.6-87.8.6-.8,1.4-1.5,1.8-2.3,3.9-8.6,10.7-10.7,19.9-10.8,149.9-.3,299.8,1.2,449.7-.7,7.5,0,13.5,2.8,17.1,9.8,1.9,3.7,3.8,7.3,5.8,10.9,0,38.9,0,77.7,0,116.6-1.5.3-1.5,1.3-1.8,2.5-.9,3.7-1.8,7.4-3,11-3.8,11-11.6,16.4-23.2,16.4-145.1,0-290.2,0-435.2,0-11.5,0-21.1-3.6-28.2-12.8-.7-.9-1.1-2.1-2.5-2.2Z"
          />
          <path
            className="cls-4"
            d="m514.3,51.6c-1.9-3.6-3.9-7.3-5.8-10.9-3.5-7-9.5-9.9-17.1-9.8-149.9,1.9-299.8.4-449.7.7-9.1,0-15.9,2.2-19.9,10.8-.4.9-1.2,1.6-1.8,2.3,0-3.9-.8-7.9.4-11.8,3.1-10.4,9.9-14.9,20.9-12.8,4,.7,7.9.7,11.8.7,144.2,0,288.5,0,432.7.1,4,0,7.9-.6,11.7-1.2,8.9-1.4,16.8,8.2,16.8,16,0,5.3-.1,10.6-.2,15.9Z"
          />
          <path
            className="cls-2"
            d="m20.3,183.1c1.4.1,1.8,1.3,2.5,2.2,7.1,9.3,16.7,12.8,28.2,12.8,145.1,0,290.2,0,435.2,0,11.6,0,19.4-5.4,23.2-16.4,1.2-3.6,2.1-7.3,3-11,.3-1.2.4-2.3,1.8-2.5,0,8.1.5,16.3.1,24.4-.4,7.2-5.9,16.2-15.8,14.5-.5,0-1,0-1.5,0-154.3,0-308.6,0-462.9,0-7.7,0-13.6-6.6-14.1-16-.1-2.6.1-5.3.2-7.9Z"
          />
        </g>
      </g>
      <foreignObject
...
export default ButtonText_Small_Orange_Square;
